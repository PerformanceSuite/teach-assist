...
export function GenerateStep() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-1">Generate Narratives</h2>
      ...
      <div className="space-y-6">
        {/* Tone Selection */}
        <div>
          <h3 className="text-gray-900 dark:text-white font-medium mb-3">Narrative Tone</h3>
        ...
        <div className="flex items-start gap-3">
          <input
            ...
            className="mt-1 w-4 h-4 rounded border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-blue-500 focus:ring-blue-500 focus:ring-offset-white dark:focus:ring-offset-gray-900"
          />
          <label htmlFor="growthArea" className="cursor-pointer">
            <div className="text-gray-900 dark:text-white font-medium">Include growth area</div>
        ...
        {/* Council Review */}
        <div>
          <h3 className="text-gray-900 dark:text-white font-medium mb-3">Council Review (Optional)</h3>
          ...
          <div className="flex items-start gap-3">
            ...
            <label htmlFor="equityAdvocate" className="cursor-pointer">
              <div className="text-gray-900 dark:text-white font-medium">Equity Advocate</div>
              <div className="text-gray-500 dark:text-gray-400 text-sm">
      ...
      {/* Error Display */}
      {generationError && (
        <div role="alert" className="bg-red-50 dark:bg-red-500/10 border border-red-200 dark:border-red-500/20 rounded-lg p-4 flex items-start gap-3">
          <AlertCircle className="w-5 h-5 text-red-600 dark:text-red-400 flex-shrink-0 mt-0.5" />
          <div>
            <div className="text-red-600 dark:text-red-400 font-medium">Generation failed</div>
            <div className="text-red-500 dark:text-red-300 text-sm mt-1">{generationError}</div>
          </div>
        </div>
      )}
      ...
      {isGenerating && (
        <div className="space-y-4">
          <div className="bg-gray-100 dark:bg-gray-800/50 rounded-lg p-6 border border-gray-300 dark:border-gray-700">
          ...
          <div className="space-y-3">
            {Array.from({ length: Math.min(students.length, 3) }).map((_, i) => (
              <div key={i} className="bg-gray-100 dark:bg-gray-800/50 rounded-lg border border-gray-300 dark:border-gray-700 p-4 animate-pulse">
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-12 h-8 bg-gray-300 dark:bg-gray-700 rounded" />
                  <div className="w-16 h-5 bg-gray-300 dark:bg-gray-700 rounded" />
                </div>
      ...
      <div className="flex justify-between pt-4 border-t border-gray-200 dark:border-gray-800">
        <button
          ...
          className="flex items-center gap-2 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 disabled:bg-gray-100 dark:disabled:bg-gray-800 disabled:text-gray-400 dark:disabled:text-gray-600 text-gray-700 dark:text-gray-300 px-4 py-2.5 rounded-lg font-medium transition-colors"
        >
