...
export function ExportStep() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-semibold text-white mb-1">Export Narratives</h2>
      ...
      {preview && (
        <div className="space-y-4">
          ...
          <div className="bg-gray-900 rounded-lg border border-gray-700 p-4 max-h-96 overflow-auto">
