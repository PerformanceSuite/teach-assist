    ...
    <div className="space-y-6">
      <section className="rounded-lg border p-4">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          <Link className="rounded-md bg-black px-3 py-2 text-sm text-white" href="/app/grade">
      ...
      <section className="grid gap-4 md:grid-cols-2">
        <div className="rounded-lg border p-4">
          ...
          <p className="mt-1 text-sm text-neutral-600">Feedback drafts, message drafts, lesson drafts.</p>
        </div>
        <div className="rounded-lg border p-4">
          <h3 className="font-semibold">Instant Capture (placeholder)</h3>
          <p className="mt-1 text-sm text-neutral-600">One-click capture of insights, linked to context.</p>
        </div>
      </section>
    </div>
  );
