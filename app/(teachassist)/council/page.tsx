      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-2xl font-semibold text-gray-900 dark:text-white">Inner Council</h1>
          </div>
          ...
          {loadingPersonas ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {personas.map(persona => (
                ...
                >
                  <div className="font-semibold text-gray-900 dark:text-white">{persona.name}</div>
                  <div className="text-sm text-gray-500 dark:text-gray-400 mt-1">{persona.description}</div>
                </button>
              ))}
            </div>
          )}
        ...
        <div className="space-y-2">
          ...
          <textarea
            ...
            className="w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 p-3 text-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 resize-none focus:border-purple-500 focus:outline-none focus:ring-1 focus:ring-purple-500"
            rows={4}
            disabled={loading}
          />
        </div>
        ...
        {/* Error Display */}
        {error && (
          <div className="rounded-lg bg-red-50 dark:bg-red-500/10 border border-red-200 dark:border-red-500/50 p-4 text-sm text-red-600 dark:text-red-400">
            {error}
          </div>
        )}
        ...
        {response && (
          <div className="space-y-3">
            ...
            <div className="rounded-lg border-2 border-purple-200 dark:border-purple-500/50 bg-purple-50 dark:bg-purple-500/10 p-6">
        ...
        <div className="rounded-lg bg-blue-50 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-500/50 p-4 text-sm text-blue-600 dark:text-blue-400">
          ...
          <ul className="space-y-1 ml-4 list-disc text-gray-500 dark:text-gray-400">
