  ...
  return (
    <div className="h-full overflow-auto p-6 bg-gray-50 dark:bg-gray-950">
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between pb-4 border-b border-gray-200 dark:border-gray-800">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-semibold text-gray-900 dark:text-white tracking-tight">Curriculum Sources</h1>
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Manage documents and standards powering your AI</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white font-medium rounded-lg transition-colors shadow-sm"
              >
        ...
        {/* Actionable Tip */}
        <div className="rounded-xl bg-gray-100 dark:bg-gray-800/50 border border-gray-300/50 dark:border-gray-700/50 p-4 flex items-start gap-3 mt-8">
          <Lightbulb className="w-5 h-5 text-amber-400 flex-shrink-0 mt-0.5" />
          <div>
            <div className="font-medium text-gray-700 dark:text-gray-200 mb-1">Workflow Tip</div>
      ...
      {isUploadModalOpen && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          {/* Modal Content */}
          <div className="relative w-full max-w-2xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="p-6">
              {/* Tab buttons */}
              <div className="flex gap-2 mb-6 p-1 bg-gray-100 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-800 w-fit">
                <button
              ...
              {/* Tab content */}
              <div className="bg-gray-50 dark:bg-gray-950/50 rounded-xl p-6 border border-gray-200 dark:border-gray-800">
                {activeTab === 'file' ? (
